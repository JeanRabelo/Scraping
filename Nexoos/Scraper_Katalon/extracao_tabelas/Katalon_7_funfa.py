...
saida_csv.writerow(['nome_empresa', 'prazo', 'rating', 'TIR', 'valor', 'pagina', 'codigo_emprestimo', 'porcentagem'])
...
def importar_tabela(pagina):
    ...
    for linha in tabela_antiga_linhas:
        ...
        porcentagem = linha.find('span', attrs={"class": "percentage_raised"}).text
        saida_csv.writerow([nome_empresa, prazo, rating, TIR, valor, pagina, codigo_emprestimo, porcentagem])
